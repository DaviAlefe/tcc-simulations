...
def get_phases(db_path, t_start, t_end, n_nodes):
    print(db_path)
    ...
    initial_df['phi'] = 2*np.pi*(initial_df['burst_num'] + (initial_df['t'] - initial_df['t_last'])/(initial_df['t_next'] - initial_df['t_last']))
